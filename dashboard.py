...
# ── TABS ──────────────────────────────────────────────────────────────────────
tab_señales, tab_perf, tab_arb, tab_corr, tab_port, tab_opciones, tab_ib, tab_ipsa, tab_chile, tab_usa, tab_div, tab_kalshi, tab_noticias, tab_hist, tab_bt = st.tabs([
    "🎯 SEÑALES", "💹 PERFORMANCE", "🔀 ARBITRAJE", "📡 CORRELACIONES", "🧮 PORTAFOLIO", "⚙️ OPCIONES", "🤖 IB TRADING",
